...
public class CartsController implements CartApi {
    ...
    @Override
    public ResponseEntity<List<Item>> addOrReplaceItemsByCustomerId(final String customerId,
                                                                    @Valid final Item item) {
        return null;
    }
    ...
    @Override
    public ResponseEntity<List<Item>> getCartItemsByCustomerId(final String customerId) {
        return null;
    }

    @Override
    public ResponseEntity<List<Item>> getCartItemsByItemId(final String customerId, final String itemId) {
        return null;
    }
}
